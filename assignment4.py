...
# SelectBox
nameee = ['Kerala','Andhra Pradesh','Arunachal Pradesh','Assam','Bihar','Chandigarh','Delhi','Goa','Gujarat',
            'Haryana','Himachal Pradesh','Jammu and Kashmir','Jharkhand','Karnataka','Madhya Pradesh','Maharashtra',
            'Manipur', 'Meghalaya','Mizoram','Nagaland','Odisha','Punjab','Rajasthan','Sikkim','Tamil Nadu','Telengana',
            'West Bengal','Tripura','Uttar Pradesh','Uttarakhand']
state = st.selectbox("Select State",nameee)
st.write("Showing the few details of ",state)
